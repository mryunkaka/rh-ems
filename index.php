...
<head>
    ...
    <style>
        ...
        * {
        ...
        /* Header card dengan tombol & link agar rapi di HP */
        .card-header-actions {
            display: flex;
            flex-wrap: wrap;
            gap: 8px;
                ...
                <div class="card-header card-header-actions">
                    ...
                    <div class="card-header-actions-right">
                        <a href="<?= htmlspecialchars($sheetEditUrl) ?>"
                            target="_blank"
                            style="color:#93c5fd;text-decoration:none;font-size:13px;">
                            Klik di sini untuk memastikan Spreadsheets (update)
                        </a>
                        <form method="post" style="margin:0;">
                            <input type="hidden" name="action" value="end_medic">
                            <button type="submit" class="btn-danger">Akhiri Session</button>
                        </form>
                    </div>
                </div>
